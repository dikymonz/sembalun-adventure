...
const DetailPackages = () => {
  return (
      <div>
        <section className='bg-white dark:bg-gray-900' id='detail_package'>
            <div className='gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6'>
                <div className='font-light text-gray-500 sm:text-lg dark:text-gray-400'>
                    <h2 className='mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white'>Rinjani Trekking</h2>
                    <p>2D/3N</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, explicabo.</p>
                    <div className='mt-2'>
                    <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Includes:</h2>
...
<button type="button" className="mt-5 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Booking Now</button>
                ...
                <div className='grid grid-cols-2 gap-4 mt-8'>
                    <img className='w-full rounded-lg' src={assets.image1} alt="content1" />
                    <img className='mt-4 w-full lg:mt-10 rounded-lg' src={assets.image2} alt="content2" />
                </div>
            </div>
        </section>
    </div>
