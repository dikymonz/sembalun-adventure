  ...
  return (
    ...
    >
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
        Travel <span className='underline underline-offset-4 decoration-1 font-light text-center'>Package</span>
      </h1>
      <p className='text-gray-500 max-w-80 text-center mb-8 mx-auto'>Explore the List of Lombok Tour Packages.</p>
      ...
      <div className='overflow-hidden cursor-pointer'>
        ...
        >
          {projectsData.map((project, index) => (
            <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4' onClick={() => setSelectedPackage(project)}>
